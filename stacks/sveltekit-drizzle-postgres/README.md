...
display_name: SvelteKit 2 · Svelte 5 · Drizzle 0.45 · Postgres 16 · Playwright · Vitest 2
components: [sveltekit-2, svelte-5, drizzle-0.45, postgres-16, playwright-1.60, vitest-2]
verified_with: []
...
- **Drizzle 0.45 over Prisma.** Thin SQL-shaped query builder, no separate engine binary, codegen is just types. Pairs cleanly with `postgres-js`.
