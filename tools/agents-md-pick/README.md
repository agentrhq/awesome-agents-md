...
Copies a stack's AGENTS.md into your repo. Zero dependencies, Node 18+.
...
1. Resolves the slug (exact or unambiguous substring match) against the [15 stacks in the gallery](https://github.com/agentrhq/awesome-agents-md/tree/main/stacks).
